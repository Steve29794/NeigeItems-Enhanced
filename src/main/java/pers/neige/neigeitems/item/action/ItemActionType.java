...
public enum ItemActionType {
    ...
    BLOCKING("blocking"),
    DAMAGE("damage"),
    DAMAGED_HAND("damaged_hand"),
    DAMAGED_OFFHAND("damaged_offhand"),
    DAMAGED_HEAD("damaged_head"),
    DAMAGED_CHEST("damaged_chest"),
    DAMAGED_LEGS("damaged_legs"),
    DAMAGED_FEET("damaged_feet"),
    KILL_HAND("kill_hand"),
